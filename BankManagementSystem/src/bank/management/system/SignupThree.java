...
public class SignupThree extends JFrame implements ActionListener
{
	...
	SignupThree(String formno){
	   ...
	   pnumber.setBounds(320,300,300,30);
	   add(pnumber);
	   
	   JLabel pinDetail = new JLabel("Your 4 digit pin number");
	   pinDetail.setFont(new Font("Raleway",Font.BOLD,13));
	   pinDetail.setBounds(100,320,300,30);
	   add(pinDetail);
	   ...
	   c7.setBounds(80,530,700,30);
	   add(c7);
	   
	   cancel = new JButton("Cancel");
	   cancel.setBackground(Color.BLACK);
	   cancel.setForeground(Color.WHITE);
	   cancel.setBounds(240,580,100,30);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource() == submit)
		{
			...
			if(c3.isSelected())
			{
				facility  = facility +" Mobie Banking";
			}
			if(c4.isSelected())
			{
